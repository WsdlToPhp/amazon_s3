<?php
/**
 * File for class AmazonS3StructVersionEntry
 * @package AmazonS3
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for AmazonS3StructVersionEntry originally named VersionEntry
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class AmazonS3StructVersionEntry extends AmazonS3WsdlClass
{
	/**
	 * The Key
	 * @var string
	...
	public $StorageClass;
	/**
	 * Constructor method for VersionEntry
	 ...
	 */
	public function __construct($_key = NULL,$_versionId = NULL,$_isLatest = NULL,$_lastModified = NULL,$_eTag = NULL,$_size = NULL,$_owner = NULL,$_storageClass = NULL)
	{
		parent::__construct(array('Key'=>$_key,'VersionId'=>$_versionId,'IsLatest'=>$_isLatest,'LastModified'=>$_lastModified,'ETag'=>$_eTag,'Size'=>$_size,'Owner'=>$_owner,'StorageClass'=>$_storageClass));
	}
	/**
	 * Get Key value
	 * @return string|null

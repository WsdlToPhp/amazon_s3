<?php
/**
 * File for AmazonS3WsdlClass to communicate with SOAP service
 * @package AmazonS3
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
/**
 * AmazonS3WsdlClass to communicate with SOAP service
 * 
 * @package AmazonS3
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class AmazonS3WsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses AmazonS3WsdlClass::setLastError()
	 * @uses AmazonS3WsdlClass::initSoapClient()
	 * @uses AmazonS3WsdlClass::initInternArrayToIterate()
	 * @uses AmazonS3WsdlClass::_set()
	...
	public static function __set_state(array $_array,$_className = __CLASS__)
	{
		if(class_exists($_className))
		{
			...
			if(is_object($object) && is_subclass_of($object,'AmazonS3WsdlClass'))
			{
	 ...
	 * @uses AmazonS3ClassMap::classMap()
	 * @uses AmazonS3WsdlClass::getDefaultWsdlOptions()
	 * @uses AmazonS3WsdlClass::setSoapClient()
	 * @param array $_wsdlOptions WSDL options
	 * @return void
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('AmazonS3ClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = AmazonS3ClassMap::classMap();
	 ...
	 * @uses AmazonS3WsdlClass::WSDL_CACHE_WSDL
	 * @uses AmazonS3WsdlClass::WSDL_COMPRESSION
	 * @uses AmazonS3WsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses AmazonS3WsdlClass::WSDL_ENCODING
	 * @uses AmazonS3WsdlClass::WSDL_EXCPTS
	 * @uses AmazonS3WsdlClass::WSDL_FEATURES
	 * @uses AmazonS3WsdlClass::WSDL_LOGIN
	 * @uses AmazonS3WsdlClass::WSDL_PASSWD
	 * @uses AmazonS3WsdlClass::WSDL_SOAP_VERSION
	 * @uses AmazonS3WsdlClass::WSDL_STREAM_CONTEXT
	 * @uses AmazonS3WsdlClass::WSDL_TRACE
	 * @uses AmazonS3WsdlClass::WSDL_TYPEMAP
	 * @uses AmazonS3WsdlClass::WSDL_URL
	 * @uses AmazonS3WsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses AmazonS3WsdlClass::getSoapClient()
	 * @uses AmazonS3WsdlClass::getFormatedXml()
	 ...
	 * @uses AmazonS3WsdlClass::getSoapClient()
	 * @uses AmazonS3WsdlClass::convertStringHeadersToArray()
	 ...
	 * @uses AmazonS3WsdlClass::getInternArrayToIterate()
	 * @uses AmazonS3WsdlClass::getInternArrayToIterateIsArray()
	 * @return int
	 */
	 ...
	 * @uses AmazonS3WsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses AmazonS3WsdlClass::getInternArrayToIterateOffset()
	 * @uses AmazonS3WsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses AmazonS3WsdlClass::getInternArrayToIterateOffset()
	 * @uses AmazonS3WsdlClass::offsetExists()
	 * @return bool true|false
	 */
	 ...
	 * @see AmazonS3WsdlClass::offsetGet()
	 * @uses AmazonS3WsdlClass::offsetGet()
	 * @param int $_index
	 * @return mixed
	 */
	 ...
	 * @uses AmazonS3WsdlClass::getAttributeName()
	 * @uses AmazonS3WsdlClass::__toString()
	 * @uses AmazonS3WsdlClass::_set()
	 * @uses AmazonS3WsdlClass::_get()
	 * @uses AmazonS3WsdlClass::setInternArrayToIterate()
	 * @uses AmazonS3WsdlClass::setInternArrayToIterateIsArray()
	 * @uses AmazonS3WsdlClass::setInternArrayToIterateOffset()

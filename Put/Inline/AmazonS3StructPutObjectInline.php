<?php
/**
 * File for class AmazonS3StructPutObjectInline
 * @package AmazonS3
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for AmazonS3StructPutObjectInline originally named PutObjectInline
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class AmazonS3StructPutObjectInline extends AmazonS3WsdlClass
{
	/**
	 * The Bucket
	 * @var string
	...
	public $Credential;
	/**
	 * Constructor method for PutObjectInline
	 ...
	 * @return AmazonS3StructPutObjectInline
	 */
	public function __construct($_bucket = NULL,$_key = NULL,$_metadata = NULL,$_data = NULL,$_contentLength = NULL,$_accessControlList = NULL,$_storageClass = NULL,$_aWSAccessKeyId = NULL,$_timestamp = NULL,$_signature = NULL,$_credential = NULL)
	{
		parent::__construct(array('Bucket'=>$_bucket,'Key'=>$_key,'Metadata'=>$_metadata,'Data'=>$_data,'ContentLength'=>$_contentLength,'AccessControlList'=>$_accessControlList,'StorageClass'=>$_storageClass,'AWSAccessKeyId'=>$_aWSAccessKeyId,'Timestamp'=>$_timestamp,'Signature'=>$_signature,'Credential'=>$_credential));
	}
	/**
	 * Get Bucket value
	 * @return string|null

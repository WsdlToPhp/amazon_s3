<?php
/**
 * File for class AmazonS3StructGetBucketLoggingStatus
 * @package AmazonS3
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for AmazonS3StructGetBucketLoggingStatus originally named GetBucketLoggingStatus
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class AmazonS3StructGetBucketLoggingStatus extends AmazonS3WsdlClass
{
	/**
	 * The Bucket
	 * @var string
	...
	public $Credential;
	/**
	 * Constructor method for GetBucketLoggingStatus
	 ...
	 * @return AmazonS3StructGetBucketLoggingStatus
	 */

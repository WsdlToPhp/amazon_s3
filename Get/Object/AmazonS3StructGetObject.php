<?php
/**
 * File for class AmazonS3StructGetObject
 * @package AmazonS3
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for AmazonS3StructGetObject originally named GetObject
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class AmazonS3StructGetObject extends AmazonS3WsdlClass
{
	/**
	 * The Bucket
	 * @var string
	...
	public $Credential;
	/**
	 * Constructor method for GetObject
	 ...
	 * @return AmazonS3StructGetObject
	 */
	public function __construct($_bucket = NULL,$_key = NULL,$_getMetadata = NULL,$_getData = NULL,$_inlineData = NULL,$_aWSAccessKeyId = NULL,$_timestamp = NULL,$_signature = NULL,$_credential = NULL)
	{
		parent::__construct(array('Bucket'=>$_bucket,'Key'=>$_key,'GetMetadata'=>$_getMetadata,'GetData'=>$_getData,'InlineData'=>$_inlineData,'AWSAccessKeyId'=>$_aWSAccessKeyId,'Timestamp'=>$_timestamp,'Signature'=>$_signature,'Credential'=>$_credential));
	}
	/**
	 * Get Bucket value
	 * @return string|null

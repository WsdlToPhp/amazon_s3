<?php
/**
 * File for class AmazonS3StructGetObjectExtendedResponse
 * @package AmazonS3
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for AmazonS3StructGetObjectExtendedResponse originally named GetObjectExtendedResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class AmazonS3StructGetObjectExtendedResponse extends AmazonS3WsdlClass
{
	/**
	...
	/**
	 * Constructor method for GetObjectExtendedResponse

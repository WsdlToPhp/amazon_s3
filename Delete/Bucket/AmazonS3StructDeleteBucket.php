<?php
/**
 * File for class AmazonS3StructDeleteBucket
 * @package AmazonS3
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for AmazonS3StructDeleteBucket originally named DeleteBucket
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class AmazonS3StructDeleteBucket extends AmazonS3WsdlClass
{
	/**
	 * The Bucket
	 * @var string
	...
	public $Credential;
	/**
	 * Constructor method for DeleteBucket
	 ...
	 * @return AmazonS3StructDeleteBucket
	 */

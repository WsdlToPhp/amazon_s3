<?php
/**
 * File for class AmazonS3StructDeleteObject
 * @package AmazonS3
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for AmazonS3StructDeleteObject originally named DeleteObject
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class AmazonS3StructDeleteObject extends AmazonS3WsdlClass
{
	/**
	 * The Bucket
	 * @var string
	...
	public $Credential;
	/**
	 * Constructor method for DeleteObject
	 ...
	 * @return AmazonS3StructDeleteObject
	 */

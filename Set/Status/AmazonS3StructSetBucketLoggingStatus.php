<?php
/**
 * File for class AmazonS3StructSetBucketLoggingStatus
 * @package AmazonS3
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for AmazonS3StructSetBucketLoggingStatus originally named SetBucketLoggingStatus
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class AmazonS3StructSetBucketLoggingStatus extends AmazonS3WsdlClass
{
	/**
	 * The Bucket
	 * @var string
	...
	public $Credential;
	/**
	 * The BucketLoggingStatus
	 * @var AmazonS3StructBucketLoggingStatus
	 */
	public $BucketLoggingStatus;
	/**
	 * Constructor method for SetBucketLoggingStatus
	 ...
	 * @param AmazonS3StructBucketLoggingStatus $_bucketLoggingStatus
	 * @return AmazonS3StructSetBucketLoggingStatus
	 */
	public function __construct($_bucket = NULL,$_aWSAccessKeyId = NULL,$_timestamp = NULL,$_signature = NULL,$_credential = NULL,$_bucketLoggingStatus = NULL)
	{
		parent::__construct(array('Bucket'=>$_bucket,'AWSAccessKeyId'=>$_aWSAccessKeyId,'Timestamp'=>$_timestamp,'Signature'=>$_signature,'Credential'=>$_credential,'BucketLoggingStatus'=>$_bucketLoggingStatus));
	}
	/**
	 * Get Bucket value
	 * @return string|null
	...
	/**
	 * Get BucketLoggingStatus value
	 * @return AmazonS3StructBucketLoggingStatus|null
	 */
	public function getBucketLoggingStatus()
	{
		return $this->BucketLoggingStatus;
	}
	/**
	 * Set BucketLoggingStatus value
	 * @param AmazonS3StructBucketLoggingStatus $_bucketLoggingStatus the BucketLoggingStatus
	 * @return AmazonS3StructBucketLoggingStatus
	 */
	public function setBucketLoggingStatus($_bucketLoggingStatus)
	{
		return ($this->BucketLoggingStatus = $_bucketLoggingStatus);
	}
	/**

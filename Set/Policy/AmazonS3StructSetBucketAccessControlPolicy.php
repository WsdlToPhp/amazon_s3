<?php
/**
 * File for class AmazonS3StructSetBucketAccessControlPolicy
 * @package AmazonS3
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for AmazonS3StructSetBucketAccessControlPolicy originally named SetBucketAccessControlPolicy
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class AmazonS3StructSetBucketAccessControlPolicy extends AmazonS3WsdlClass
{
	/**
	 * The Bucket
	 * @var string
	...
	public $Credential;
	/**
	 * Constructor method for SetBucketAccessControlPolicy
	 ...
	 * @return AmazonS3StructSetBucketAccessControlPolicy
	 */
	public function __construct($_bucket = NULL,$_accessControlList = NULL,$_aWSAccessKeyId = NULL,$_timestamp = NULL,$_signature = NULL,$_credential = NULL)
	{
		parent::__construct(array('Bucket'=>$_bucket,'AccessControlList'=>$_accessControlList,'AWSAccessKeyId'=>$_aWSAccessKeyId,'Timestamp'=>$_timestamp,'Signature'=>$_signature,'Credential'=>$_credential));
	}
	/**
	 * Get Bucket value
	 * @return string|null
